...
#Change the x for the gatk version
GATK_PATH=/gatk/gatk-4.0.x/gatk
...
#REFERENCE_FOLDER=/reference/GRCh37/
#KNOWN_SITES=/ngs/b37/dbsnp_138.b37.vcf,/ngs/b37/Mills_and_1000G_gold_standard.indels.b37.vcf
...
sudo docker exec -t $spark_masterID bash /NGS-SparkGATK/docker/run/pipeline1.sh $GATK_PATH $REFERENCE_FOLDER $OUT_FOLDER $known